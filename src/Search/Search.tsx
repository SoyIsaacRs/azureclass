    ...
    <>
      ...
      {message !== "" ? (
        ...
        <div className={styles.container}>
          {data.map(({ albumName, name, previewURL,albumId }, index) => (
            <Result
              key={index}
              setSong={setSong}
              album={albumName}
...
const Result: FC<{
  ...
  controls: HTMLMediaControls
  songInfo: song
}> = ({ album, song, url, albumImage,setSong, state, controls, songInfo }) => {
      ...
      <div
        ...
        onClick={() => {
          if (itIsMe) {
            ...
            setSong({ albumName: album, songName: song, url,albumIcon:albumImage, needToPlay: true })
          }
        }}
      >
