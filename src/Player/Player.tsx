...
import { BiLoader, BiPause, BiPlay, BiVolumeFull, BiVolumeMute } from "react-icons/bi"
      ...
      <div className={styles.container}>
        <div className={styles.info}>
          <div className={styles.icon}>
            {songInfo?.albumIcon ? <img src={`https://api.napster.com/imageserver/v2/albums/${songInfo?.albumIcon}/images/110x110.jpg `}/>: null}
          </div>
